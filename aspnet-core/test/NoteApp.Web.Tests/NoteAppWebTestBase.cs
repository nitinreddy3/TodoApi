...
{
    public abstract class NoteAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NoteAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NoteAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NoteAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NoteAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NoteAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NoteAppDbContext, Task<T>> func)
        {
            T result;
